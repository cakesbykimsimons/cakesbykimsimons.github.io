...
<figure class="blog-image">
  <Image src={img1} alt="Devin's Halloween painting of a black wolf, jack-o'-lantern, scarecrow, and crows under a crescent moon." />
...
<figure class="blog-image">
  <Image src={img2} alt="Devin Michael Housman smiling in a maroon and gray sweatshirt kneeling by scarecrows." />
