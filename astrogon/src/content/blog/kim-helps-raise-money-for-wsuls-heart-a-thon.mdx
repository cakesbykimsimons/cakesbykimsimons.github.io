...
imageAlt: "Three women holding heart cards in front of a De Filippis Bakery sign."
...
<figure class="blog-image">
  <Image
    src={img1}
    alt="Three women holding heart cards in front of a De Filippis Bakery sign."
  />
  <figcaption>
