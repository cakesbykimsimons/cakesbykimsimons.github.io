...
<figure class="blog-image">
    <Image src={img1} alt="" />
    <figcaption>
        At Burn Brae Mansion, it's basically Halloween all year round. Ghosts have been spotted in the 116-year-old house.
    </figcaption>
</figure>
...
<figure class="blog-image">
    <Image src={img2} alt="" />
    <figcaption>
        The table is ready for dinner at Burn Brae Mansion.
    </figcaption>
</figure>
...
<figure class="blog-image">
    <Image src={img5} alt="" />
    <figcaption>
        Heat up your favorite hard candy: 30 seconds in microwave, then 15-second intervals until it boils (you'll see bubbles). Be careful—candy will be hot...
    </figcaption>
</figure>
...
<figure class="blog-image">
    <Image src={img7} alt="" />
    <figcaption>
        Heat up clear isomalt as you did the candy (again, use caution—liquid will be hot). Pour into mold. Use sugar torch to eliminate bubbles. Let harden...
    </figcaption>
</figure>
...
<figure class="blog-image">
    <Image src={img11} alt="" />
    <figcaption>
        Heat apple with sugar torch and attach the eye. Enjoy your creepy but delicious treat!..
    </figcaption>
</figure>
