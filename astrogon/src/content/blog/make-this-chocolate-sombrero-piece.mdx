...
<figure class="blog-image">
    <Image src={img1} alt="" />
    <figcaption>
        The chocolate sombrero, an homage to El Sombrero Restaurant in Rock Hill, NY.
    </figcaption>
</figure>
...
*Kim M. Simons is an artist, food artist and cake artist. A two-time Food Network champion, Kim also has 11.5 doves on the Sullivan Catskills Dove Trail, with two more in progress. Kim is available to teach classes, both individually and in groups. Visit Kim at www.cakesbykimsimons.com.* 
