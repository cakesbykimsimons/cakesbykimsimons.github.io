...
<figure class="blog-image">
  <Image src={img1} alt="A repurposed scooter bar cart stocked with liquor and wine bottles at Solaia Restaurant." />
  <figcaption>
...
<figure class="blog-image">
  <Image src={img2} alt="A wall-mounted wine rack displaying wine bottles at Solaia Restaurant in Monticello, New York." />
  <figcaption>
