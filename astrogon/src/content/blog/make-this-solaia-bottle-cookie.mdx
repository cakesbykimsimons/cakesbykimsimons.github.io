...
<figure class="blog-image">
    <Image src={img1} alt="" />
    <figcaption>
        The Solaia bottle and glass cookies
    </figcaption>
</figure>
...
<figure class="blog-image">
    <Image src={img8} alt="" />
    <figcaption>
        Print labels for the bottle and any design for the glass on edible paper using edible ink. Cut out printed labels/designs on edible wafer paper with scissors.
    </figcaption>
</figure>
...
<figure class="blog-image">
    <Image src={img9} alt="" />
    <figcaption>
        Attach labels/designs to cookies with piping gel...
    </figcaption>
</figure>
