...
<figure class="blog-image">
  <Image src={img1} alt="" />
  <figcaption>The completed sunflower brownies.</figcaption>
</figure>
...
<figure class="blog-image">
  <Image src={img5} alt="" />
  <figcaption>
    Roll out gumpaste thinly. Tip: use corn starch. Then cut sunflower out of
    gumpaste, using a sunflower cookie cutter. Tip: dust the cookie cutter with
    corn starch.
  </figcaption>
</figure>
...
<figure class="blog-image">
  <Image src={img7} alt="" />
  <figcaption>
    Remove the sunflower from the cup with a cake tool. Paint the sunflower with
    edible paint.
  </figcaption>
</figure>
...
<figure class="blog-image">
  <Image src={img8} alt="" />
  <figcaption>Dust the sunflower with edible dust.</figcaption>
</figure>

<figure class="blog-image">
  <Image src={img9} alt="" />
  <figcaption>Add piping gel and sprinkles to the center.</figcaption>
</figure>

<figure class="blog-image">
  <Image src={img10} alt="" />
  <figcaption>Cut circles from a prepared pan of frosted brownies.</figcaption>
</figure>
