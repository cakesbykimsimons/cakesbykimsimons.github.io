...
import img1 from "@assets/recipes/avocado-banana-frozen-treats/avocado-banana-frozen-treats.jpg";
...
<figure class="blog-image">
  <Image
    src={img1}
    alt="Two green avocado-banana frozen treats on sticks arranged on a plate with one split in half"
  />
  <figcaption>
    This month's project is Avocado-Banana Frozen Treats. In creating the
    treats, I wanted to stay away from any ultra-processed component, and used
    only the best ingredients available: organic bananas, organic avocado,
    organic coconut milk, real maple syrup, organic lemons and dark—not
    milk—chocolate.
  </figcaption>
</figure>
...
<figure class="blog-image">
  <Image
    src={img2}
    alt="Blended green avocado-banana mixture being placed into molds"
  />
  <figcaption>
    The treats include avocado, which—among other things—helps boost good
    cholesterol. Then factor in the bananas, which contain fiber and
    antioxidants. The lemons are high in vitamin C, which helps fortify the
    immune system. In this step, cut up all the bananas and avocado, and blend
    till smooth. Pour into molds and freeze.
  </figcaption>
</figure>
...
<figure class="blog-image">
  <Image
    src={img3}
    alt="Green avocado-banana frozen treats being coated with melted dark chocolate in a glass bowl"
  />
  <figcaption>
    While your treats are freezing, melt the chocolate. Then use it to coat the
    frozen treats.
  </figcaption>
</figure>
...
<Youtube
  id="AvfGpJ8UTk4"
  title="Avocado-Banana Frozen Treats video tutorial"
  client:load
/>
