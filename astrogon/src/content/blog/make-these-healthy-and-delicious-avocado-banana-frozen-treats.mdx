...
image: "@assets/blog/make-these-healthy-and-delicious-avocado-banana-frozen-treats/20240925-120519-089-39fd-_20Kim-_20main.jpg"
imageAlt: "RR photo by Kim M. Simons: This month’s project is Avocado-Banana Frozen Treats. In creating the treats, I wanted to stay away from any ultra-processed component, and used only the best ingredients available: organic bananas, organic avocado, organic coconut milk, real maple syrup, organic lemons and dark—not milk—chocolate."
showFeaturedImage: true
---

import { Image } from 'astro:assets';
import img1 from '@assets/blog/make-these-healthy-and-delicious-avocado-banana-frozen-treats/20240925-120519-089-39fd-_Kim-_main.jpg';
import img2 from '@assets/blog/make-these-healthy-and-delicious-avocado-banana-frozen-treats/20240925-120547-52c-IMG_1544__1_.jpg';
import img3 from '@assets/blog/make-these-healthy-and-delicious-avocado-banana-frozen-treats/20240925-120507-30e-treats_for_online.jpg';
import img4 from '@assets/blog/make-these-healthy-and-delicious-avocado-banana-frozen-treats/20240925-120455-735-step_two_chocolate.jpg';

<figure class="blog-image">
    <Image src={img1} alt="RR photo by Kim M. Simons: This month’s project is Avocado-Banana Frozen Treats. In creating the treats, I wanted to stay away from any ultra-processed component, and used only the best ingredients available: organic bananas, organic avocado, organic coconut milk, real maple syrup, organic lemons and dark—not milk—chocolate." />
    <figcaption>
        RR photo by Kim M. Simons: This month’s project is Avocado-Banana Frozen Treats. In creating the treats, I wanted to stay away from any ultra-processed component, and used only the best ingredients available: organic bananas, organic avocado, organic coconut milk, real maple syrup, organic lemons and dark—not milk—chocolate.
    </figcaption>
</figure>

<figure class="blog-image">
    <Image src={img2} alt="banana"/>
    <figcaption>
    </figcaption>
</figure>

<figure class="blog-image">
    <Image src={img3} alt="RR photo by Kim M. Simons: The treats include avocado, which—among other things—helps boost good cholesterol. Then factor in the bananas, which contain fiber and antioxidants. The lemons are high in vitamin C, which helps fortify the immune system. In this step, cut up all the bananas and avocado, and blend till smooth. Pour into molds and freeze." />
    <figcaption>
        RR photo by Kim M. Simons: The treats include avocado, which—among other things—helps boost good cholesterol. Then factor in the bananas, which contain fiber and antioxidants. The lemons are high in vitamin C, which helps fortify the immune system. In this step, cut up all the bananas and avocado, and blend till smooth. Pour into molds and freeze.
    </figcaption>
</figure>

<figure class="blog-image">
    <Image src={img4} alt="RR photo by Kim M. Simons: While your treats are freezing, melt the chocolate. Then use it to coat the frozen treats." />
    <figcaption>
        RR photo by Kim M. Simons: While your treats are freezing, melt the chocolate. Then use it to coat the frozen treats.
    </figcaption>
</figure>
