...
tags: [cookie-decorating, sugar-cookies, pet-portraits, dog-art, autism-awareness, diy-cookies, baking-with-friends, gift-ideas, beginner-baking]
author: kim-simons
...
imageAlt: "Two people each holding a small white dog, with decorated pet-shaped sugar cookies displayed in front"
...
<figure class="blog-image">
    <Image src={img1} alt="Two people each holding a small white dog, with decorated pet-shaped sugar cookies displayed in front" />
    <figcaption>
...
<figure class="blog-image">
    <Image src={img2} alt="Two intricately decorated sugar cookies shaped and designed to look like small white dogs including a Maltese and a Havanese" />
    <figcaption>
...
<Youtube id="AvfGpJ8UTk4" title="Cookie Out of Your Puppy video tutorial" client:load />
