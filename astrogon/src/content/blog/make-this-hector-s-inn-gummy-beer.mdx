...
tags: [food-replica, catskills, sullivan-county, tutorial]
author: kim-simons
...
<figure class="blog-image">
  <Image src={img1} alt="" />
  <figcaption>Gummy beer</figcaption>
</figure>
...
<figure class="blog-image">
  <Image src={img3} alt="" />
  <figcaption>
    Sprinkle gelatin over the water. Use a spoon to push the gelatin down into
    the water.
  </figcaption>
</figure>
...
<figure class="blog-image">
  <Image src={img5} alt="" />
  <figcaption>Add color to the gelatin mixture.</figcaption>
</figure>

<figure class="blog-image">
  <Image src={img6} alt="" />
  <figcaption>Stir and let set about 5 minutes.</figcaption>
</figure>

<figure class="blog-image">
  <Image src={img7} alt="" />
  <figcaption>
    Microwave for 30-second increments, stirring in between until mixture is
    clear and there are no visible granules. Do NOT overheat. Pour mixture into
    large paper cup about 3/4 of the way. Pour leftover gelatin in a small bowl.
  </figcaption>
</figure>
...
<figure class="blog-image">
  <Image src={img8} alt="" />
  <figcaption>
    Melt leftover gelatin. Dissolve in microwave in 30 second increments. Use
    immersion blender or whisk to make bubbles in gelatin.
  </figcaption>
</figure>
...
<figure class="blog-image">
  <Image src={img9} alt="" />
  <figcaption>
    Spoon foam into cup with the chilled gelatin mixture and let set about 15
    minutes. Remove the gummy beer from the cup—use an X-Acto blade to cut the
    cup and peel it off the gelatin beer.
  </figcaption>
</figure>
...
<figure class="blog-image">
  <Image src={img10} alt="" />
  <figcaption>
    Reheat the leftover gelatin and add the foam to the top. Let some drip down
    the sides.
  </figcaption>
</figure>
