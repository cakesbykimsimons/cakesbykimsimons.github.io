...
tags: [dog-treats, summer, recipes]
author: kim-simons
...
<figure class="blog-image">
  <Image
    src={img2}
    alt="Frozen dog berry treats on a plate alongside a chocolate-covered frozen treat for humans"
  />
  <figcaption>
    A frozen watermelon and berry treat for the dogs in your life, right, and a
    chocolate version for the humans only, on the left.
  </figcaption>
</figure>
...
<figure class="blog-image">
  <Image
    src={img1}
    alt="A small white Maltese dog with its tongue out, looking at a treat held in front of him"
  />
  <figcaption>Ozzy loves his watermelon-and-berry treats!</figcaption>
</figure>
