...
tags: [chocolate, dessert, balloon-cups, family, tribute, diy-dessert, mousse, family-recipes, nostalgic-desserts]
author: kim-simons
...
<figure class="blog-image">
    <Image src={img2} alt="Chocolate cups filled with chocolate mousse ready to be served" />
    <figcaption>
        August's project is chocolate balloon cups. Kim Simons says that her mom made these all the time, filling them with chocolate mousse, berries, or chocolate pudding and whipped cream.
    </figcaption>
</figure>
...
<figure class="blog-image">
    ...
    <figcaption>
        Carol M. Simons (12/25/1934 – 6/26/2024)
    </figcaption>
</figure>
...
<figure class="blog-image">
   <Image src={img1} alt="Ingredients and supplies for making chocolate balloon cups laid out on a baking tray atop a bright green surface" />
    <figcaption>
        Collect the items you need for the chocolate balloon cups.
    </figcaption>
</figure>

<Youtube id="MJauvLCo8Ec" title="Chocolate Balloon Cups video tutorial" client:load />
