...
description: Paint edible SmArt Sheets with blue edible colors, apply them to a fondant-covered cake, and finish with luster dust and wafer flowers.
...
supplies:
  list:
    ...
    - Paper Towels
    - Eye Dropper
    - "Edible Coloring: Azure Blue and Breakfast Blue (I Prefer Artisan Accents)"
    - Bowls
    - Water
    - Piping Gel
    - Gold Luster Dust
...
notes:
  ...
  - Let the colored SmArt Sheets dry overnight before applying to the cake.
---
